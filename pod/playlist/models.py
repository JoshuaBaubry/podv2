...
class Playlist(models.Model):
    ...
    slug = models.SlugField(
        ...
        help_text=_('Used to access this instance, the "slug" is a short' +
                    ...
                    ' or dash top.'))
    owner = models.ForeignKey(User, verbose_name=_('Owner'), on_delete=models.DO_NOTHING) #select2
...
class PlaylistElement(models.Model):
    playlist = models.ForeignKey(Playlist, on_delete=models.DO_NOTHING, verbose_name=_('Playlist')) #select2
