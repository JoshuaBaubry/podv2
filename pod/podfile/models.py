...
class UserFolder(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.DO_NOTHING, verbose_name=_('Owner')) #select2
...
class BaseFileModel(models.Model):
    ...
    folder = models.ForeignKey(UserFolder, on_delete=models.DO_NOTHING) #select2
    uploaded_at = models.DateTimeField(auto_now_add=True)
    created_by = models.ForeignKey( #select2
        User,
